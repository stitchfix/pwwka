...
module Pwwka
  ...
  class PersistentTransmitter
    ...
    def self.connection(routing_key, type: nil, headers: nil, message_id: :auto_generate)
      connection = self.new
      yeild(connection)
    ensure
      connection.channel_connector.connection_close
    end
    ...
    def send_message_safely(payload, routing_key, delayed: false, delay_by: nil, message_id: :auto_generate)
